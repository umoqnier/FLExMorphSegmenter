...
En el etiquetado \ref{ejemplo:linearcrf-correcto} vemos la aparición de etiquetas sistemáticas como \textsc{stem} y \texsc{3.icp}, por mencionar algunas, por lo que la frase es correctamente etiquetada.
...
\begin{exe}
    \ex \gll {bi-\'$\mu$n-gí} {y$\iota$} {mb$\muh$í} {nge} {hín} {dí-má-né} {gwa-porá} {nge} {dí-má-dáhní}\\
...
\begin{exe}
    ...
    \trans `TODO'\label{ejemplo:frase-glosada}
\end{exe}
